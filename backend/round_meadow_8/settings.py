"""
Django settings for round_meadow_8 project.
...
ROOT_URLCONF = 'round_meadow_8.urls'
...
WSGI_APPLICATION = 'round_meadow_8.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Round Meadow Support <support@round-meadow-8.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_meadow_8 API",
    "DESCRIPTION": "API documentation for round_meadow_8 App",
    "VERSION": "v1",
}
